import estatisticas
def criar_grafo():
    # Grafo com caminho euleriano predefinido (exemplo)
    grafo = {
    '1': ['2', '10'],
    '2': ['1', '3'],
    '3': ['2', '4'],
...
# Exemplo de uso
print("Utilizando um grafo predefinido com 200 vértices:")
grafo_predefinido = criar_grafo()

print("\nVerificando se o grafo possui um caminho euleriano e é conexo:")
print(possui_caminho_euleriano(grafo_predefinido))
